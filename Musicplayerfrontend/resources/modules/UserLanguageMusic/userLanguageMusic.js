app.controller("userLanguageCtrlmusic",function($state,$scope,$stateParams,Languagemusicservice,$window){
...
$scope.obj1=angular.copy($stateParams.obj6);
...
console.log("size url"+JSON.stringify($scope.urlsize));
      ...
      var str = "resources/assets/Songs/";
       ...
       var songs1=$scope.obj1;
        var poster = ["resources/modules/UserArtistMusic/Poster1.jpg"];
   ...
   $scope.playSong=function(){
        ...
        // function playOrPauseSong(){
           $scope.playOrPauseSong=function(){
            ...
            if(song.paused){
                song.play();
                $("#play img").attr("src","resources/modules/UserArtistMusic/Pause.png");
            }
            else{
                song.pause();
                $("#play img").attr("src","resources/modules/UserArtistMusic/Play.png");
            }
        }
...
app.service("Languagemusicservice",function($http){
