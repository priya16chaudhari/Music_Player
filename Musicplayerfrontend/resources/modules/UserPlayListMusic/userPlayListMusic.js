app.controller("userPlaylistCtrlmusic",function($state,$scope,$stateParams,Artistmusicservice,$window){
...
$scope.obj1=angular.copy($stateParams.obj7);
...
app.service("Artistmusicservice",function($http){
